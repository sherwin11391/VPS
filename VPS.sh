...
visible_hostname ShinX
END
sed -i $MYIP2 /etc/squid/squid.conf;

# setting banner
rm /etc/Message.net
wget -O /etc/Message.net "https://raw.githubusercontent.com/sherwin11391/VPS/master/Message.net"
sed -i 's@#Banner@Banner@g' /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/Message.net"@g' /etc/default/dropbear
service ssh restart
